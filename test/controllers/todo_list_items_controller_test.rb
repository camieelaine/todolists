...
class TodoListItemsControllerTest < ActionController::TestCase
  ...
  test "should create todo_list_item" do
    assert_difference('TodoListItem.count') do
      post :create, todo_list_item: { completed: @todo_list_item.completed, description: @todo_list_item.description, due_date: @todo_list_item.due_date, title: @todo_list_item.title }
    end
  ...
  test "should update todo_list_item" do
    patch :update, id: @todo_list_item, todo_list_item: { completed: @todo_list_item.completed, description: @todo_list_item.description, due_date: @todo_list_item.due_date, title: @todo_list_item.title }
    assert_redirected_to todo_list_item_path(assigns(:todo_list_item))
  end
